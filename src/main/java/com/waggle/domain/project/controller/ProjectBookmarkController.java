...
public class ProjectBookmarkController {
    ...
    public ResponseEntity<BaseResponse<Set<ProjectResponseDto>>> fetchMyBookmarkProjects() {
        Set<ProjectResponseDto> projectResponseDtos = projectService.getCurrentUserBookmarkProjects().stream()
    ...
    public ResponseEntity<BaseResponse<Set<ProjectResponseDto>>> fetchUserBookmarkProjects(@PathVariable String userId) {
        Set<ProjectResponseDto> projectResponseDtos = projectService.getUserBookmarkProjects(userId).stream()
                .map(ProjectResponseDto::from)
